            ...
            >
              <Slider {...CAROUSEL_SETTINGS}>
                {SLIDER_IMAGES.map((image) => (
                  <div key={image.id} className="my-4 flex items-center justify-center h-[400px] md:h-[500px]">
                    <img
                      src={image.src}
                      alt={image.alt}
          ...
          <div className="w-full sm:w-1/2">
            ...
            >
              <Slider {...SLIDER_SETTINGS} {...sliderCallbacks}>
                {SLIDER_IMAGES.map((image) => (
                  <div key={image.id} className="my-4">
                    <img
                      src={image.src}
                      alt={image.alt}
        ...
        <div className="w-full mt-6 sm:mt-8 flex flex-col space-y-6 sm:space-y-8">
            ...
            >
              <Slider {...CAROUSEL_SETTINGS}>
                {SLIDER_IMAGES.map((image) => (
                  <div
                    key={image.id}
                    className="my-2 sm:my-4 flex items-center justify-center h-[250px] sm:h-[300px] md:h-[400px] lg:h-[500px]"
                  >
                    <img
                      src={image.src}
                      alt={image.alt}
          ...
          <div className="w-full">
            ...
            >
              <Slider {...SLIDER_SETTINGS} {...sliderCallbacks}>
                {SLIDER_IMAGES.map((image) => (
                  <div key={image.id} className="my-2 sm:my-4">
                    <img
                      src={image.src}
                      alt={image.alt}
